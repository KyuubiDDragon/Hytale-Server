            ...
            <div class="flex gap-6 mb-6">
              ...
              <div class="flex-1">
                ...
                <div v-if="modtaleDetailProject.repositoryUrl" class="mt-2">
                  <a :href="modtaleDetailProject.repositoryUrl" target="_blank" rel="noopener noreferrer" class="text-cyan-400 hover:underline text-sm">
                    {{ t('mods.repository') }}
                  </a>
                </div>
              </div>
            ...
            <div class="flex gap-6 mb-6">
              ...
              <div class="flex-1">
                ...
                <div class="flex gap-3 mt-3">
                  <a v-if="stackmartDetailResource.supportUrl" :href="stackmartDetailResource.supportUrl" target="_blank" rel="noopener noreferrer" class="text-amber-400 hover:underline text-sm">
                    Support
                  </a>
                  <a v-if="stackmartDetailResource.documentationUrl" :href="stackmartDetailResource.documentationUrl" target="_blank" rel="noopener noreferrer" class="text-amber-400 hover:underline text-sm">
                    Documentation
                  </a>
                </div>
              </div>
